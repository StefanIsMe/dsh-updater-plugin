  ...
  await ctx.plugin(LlmPiAi, {
    providers: {
      deepseek: {
        ...
        baseURL,
        // Pin the output-cap spelling: pi-ai auto-detects it from the URL, and
        // these tests point at a mock host whose detection must not decide what
        // the wire assertions mean.
